...
declare namespace script {
     ...
     */
    function handle(event: scriptEvent, callback: eventCallback): undefined;
}
declare namespace render {
     ...
     */
    function rectangle(x: number, y: number, width: number, height: number, color?: number[]): undefined;
    /**
     * Renders a rectangle. Names are self-explanatory.
     * @param x X position.
     * @param y Y position.
     ...
     * @param height Rectangle height.
     */
    function rainbowRectangle(x: number, y: number, width: number, height: number): undefined;
    /**
     * Renders a rectangle. Names are self-explanatory.
     * @param x X position.
     * @param y Y position.
     ...
     * @param color 3 or 4 dimensional array with the RGBA colors.
     */
    function centeredRectangle(x: number, y: number, width: number, height: number, color?: number[]): undefined;
    /**
     * Renders a rectangle. Names are self-explanatory.
     * @param x X position.
     * @param y Y position.
     ...
     * @param color 3 or 4 dimensional array with the RGBA colors.
     */
    function roundedRectangle(x: number, y: number, width: number, height: number, color: number[]): undefined;
    /**
     * Renders a rectangle. Names are self-explanatory.
     * @param x X position.
     * @param y Y position.
     ...
     */
    function roundedRectangleOutline(x: number, y: number, width: number, height: number, radius: number, thickness: number): undefined;
    /**
     ...
     */
    function renderItemIcon(x: number, y: number, itemstack: ItemStack): undefined;
    /**
     ...
     */
    function drawLine3D(xFrom: number, yFrom: number, zFrom: number, xTo: number, yTo: number, zTo: number, color: number[], width: number, vectorFrom?: Vector3, vectorTo?: Vector3): undefined;
    /**
     * Smoothes the camera out on the Y position by not updating the camera Y position.
     */
    function smoothCamera(): undefined;
    /**
     ...
     */
    function getMinecraftFontRenderer(): FontRenderer;
    /**
     * Creates and returns a new [FontRenderer object](https://riseclients-organization.gitbook.io/rise-6-scripting-api/api-documentation/objects/fontrenderer).
     * @param name Font name.
     * @param size Font size.
     * @param antialiasing Whether to use anti-aliasing on the font renderer or not.
     */
    function getCustomFontRenderer(name: string, size: number, antialiasing: boolean): FontRenderer;
    /**
     * Creates and returns a new [FontRenderer object](https://riseclients-organization.gitbook.io/rise-6-scripting-api/api-documentation/objects/fontrenderer).
     * @param name Font name.
     * @param size Font size.
     * @param antialiasing Whether to use anti-aliasing on the font renderer or not.
     */
    function getCustomFontRendererBold(name: string, size: number, antialiasing: boolean): FontRenderer;
    /**
     * Creates and returns a new [FontRenderer object](https://riseclients-organization.gitbook.io/rise-6-scripting-api/api-documentation/objects/fontrenderer).
     * @param name Font name.
     * @param size Font size.
     * @param antialiasing Whether to use anti-aliasing on the font renderer or not.
     */
    function getCustomFontRendererItalic(name: string, size: number, antialiasing: boolean): FontRenderer;
    /**
     * Creates and returns a new [FontRenderer object](https://riseclients-organization.gitbook.io/rise-6-scripting-api/api-documentation/objects/fontrenderer).
     * @param name Font name.
     * @param size Font size.
     * @param antialiasing Whether to use anti-aliasing on the font renderer or not.
     */
    function getCustomFontRendererBoldItalic(name: string, size: number, antialiasing: boolean): FontRenderer;
    /**
...
declare namespace world {
     ...
     */
    function getDimensionId(): number;
    /**
     ...
     */
    function getTargetEntity(range: number): EntityLiving;
    /**
     * Returns all of the loaded/visible entities.
     */
...
declare namespace rise {
     ...
     */
    function registerModule(name: string, description: string): Module;
    /**
     ...
     */
    function registerCommand(name: string, description: string): Command;
    /**
     ...
     */
    function displayChat(message: string): undefined;
    /**
     * Returns the client name.
     */
    function getRiseName(): string;
    /**
     * Returns the client version.
     */
    function getRiseVersion(): string;
    /**
     * Returns `System.currentTimeMillis()`.
     */
    function getSystemMillis(): number;
    /**
     * Returns a new Vector2 with X and Y as points.
     * @param x X position
     * @param y Y position
     */
    function newVec2(x: number, y: number): Vector2;
    /**
     ...
     * @param z Z position
     */
    function newVec3(x: number, y: number, z: number): Vector3;
    /**
     ...
     */
    function displayInfoNotification(title: string, message: string, time?: number): undefined;
    /**
...
declare namespace player {
     ...
     * Returns the maximum entity hurt time.
     */
    function getMaxHurtTime(): number;
    /**
     * Returns the previous tick entity hurt time.
     */
    function getLastHurtTime(): number;
    /**
     * Returns the currently held item stack of the entity.
     */
    function getHeldItemStack(): ItemStack;
    /**
     * Returns if the entity is dead.
     */
     ...
     * Returns the previous tick entity position.
     */
    function getLastPosition(): Vector3;
    /**
     * Returns the entity motion.
     */
    function getMotion(): Vector3;
    /**
     * Returns the entity rotation.
     */
     ...
     * Returns the previous tick entity rotation.
     */
    function getLastRotation(): Vector2;
    /**
     * Returns the amount of ticks the entity has existed for.
     */
    function getTicksExisted(): number;
    /**
     * Returns the entity ID.
     */
     ...
     * @param entity Another entity
     */
    function getDistanceToEntity(entity: Entity): number;
    /**
     * Returns the distance between this entity and the specified position.
     * @param x X position.
     * @param y Y position.
     * @param z Z position.
     */
    function getDistance(x: number, y: number, z: number): number;
    /**
     ...
     */
    function message(text?: string, message?: string): undefined;
    /**
     ...
     */
    function setPosition(posX?: number, posY?: number, posZ?: number, vector?: Vector3): undefined;
    /**
     ...
     */
    function setMotion(motionX?: number, motionY?: number, motionZ?: number, vector?: Vector3): undefined;
    /**
     * Sets the player motion on the X axis.
     * @param motionX The Motion X to apply to the player.
     */
    function setMotionX(motionX: number): undefined;
    /**
     * Sets the player motion on the Y axis.
     * @param motionY The Motion Y to apply to the player.
     */
    function setMotionY(motionY: number): undefined;
    /**
     * Sets the player motion on the Z axis.
     * @param motionZ The Motion Z to apply to the player.
     */
    function setMotionZ(motionZ: number): undefined;
    /**
     * Clicks left mouse button.
     */
    function leftClick(): undefined;
    /**
     * Clicks right mouse button.
     */
    function rightClick(): undefined;
    /**
     * Attacks the target entity.
     * @param target The entity to attack.
     */
    function attackEntity(target: EntityLiving): undefined;
    /**
     * Swings the currently held item.
     */
    function swingItem(): undefined;
    /**
     ...
     */
    function setRotation(rotations: Vector2, rotationSpeed: number, movementFix: boolean): undefined;
    /**
     ...
     */
    function setHeldItem(slot: number, render: boolean): undefined;
    /**
     ...
     */
    function getClientHeldItemStack(): ItemStack;
    /**
     * Returns the **clientside** held item slot.
     */
    function getClientHeldItemSlot(): number;
    /**
     * Damages the player using a snowball/fishing rod/bow.
     */
    function itemDamage(): undefined;
    /**
     ...
     */
    function isHoldingSword(): boolean;
    /**
     * Returns whether the player is holding a tool.
     */
    function isHoldingTool(): boolean;
    /**
     ...
     */
    function mouseOverEntity(entity: Entity, range: Number): boolean;
}
declare namespace mc {
     ...
     */
    function setTimerSpeed(timerSpeed: number): undefined;
    /**
     * Returns `mc.timer.elapsedPartialTicks`.
     */
    function getPartialTicks(): number;
    /**
     * Returns `mc.timer.renderPartialTicks`.
     */
    function getRenderPartialTicks(): number;
}
/**
...
declare namespace network {
     ...
     */
    function sendPacket(id: number, ...parameters: any): undefined;
    /**
     * Those methods will either send a packet to the server, or force the client to receive a packet from the server.
     * Some packets might be unsupported. If the packet is not supported, **the script will throw an exception.**
     * Every valid packet should be supported.
     ...
     * @param parameters Parameters for instantiation of packet. Mismatch between packet constructor parameters and this variable argument **will cause the script throw an exception.**
     */
    function receivePacket(id: number, ...parameters: any): undefined;
    /**
...
declare namespace packet {
     ...
     */
    function sendKeepAlive(key: number): undefined;
    /**
     ...
     */
    function sendUseEntity(entity: Entity | number, action: string | Vector3): undefined;
    /**
     ...
     */
    function sendPosition(ground: boolean, x?: number, y?: number, z?: number, yaw?: number, pitch?: number): undefined;
    /**
     ...
     */
    function sendDigging(enumStatus: string, pos: Vector3, enumFacing: string): undefined;
    /**
     ...
     * @param z Facing Z.
     */
    function sendPlacement(pos: Vector3, direction: number, x: number, y: number, z: number): undefined;
    /**
     * Sends a C09 HeldItemChange.
     * @param slot The new slot to switch to.
     */
    function sendChangeItem(slot: number): undefined;
    /**
     * Sends a C0B EntityAction.
     * @param entityId The ID of an entity.
     * @param action The value of C0BPacketEntityAction.Action `enum`.
     */
    function sendEntityAction(entityId: number, action: string): undefined;
    /**
     * Sends a C0C Input.
     ...
     */
    function sendInput(strafeSpeed: number, forwardSpeed: number, jumping: boolean, sneaking: boolean): undefined;
    /**
     * Sends a C0D CloseWindow.
     * @param id The window ID. **This parameter is optional.**
     */
    function sendCloseWindow(id?: number): undefined;
    /**
     * Sends a C11 EnchantItem.
     * @param enchantment The enchantment ID.
     * @param window The window ID. **This parameter is optional.**
     */
    function sendEnchantItem(enchantment: number, window?: number): undefined;
    /**
     ...
     */
    function sendTransaction(window: number, uid: number, accepted: boolean): undefined;
    /**
     ...
     */
    function sendAbilities(flying?: boolean, allowFlying?: boolean, creativeMode?: boolean): undefined;
    /**
     * Sends a C14 TabComplete.
     * @param msg The message.
     * @param pos The position.
     */
    function sendTabComplete(msg: string, pos: Vector3): undefined;
    /**
     * Sends a C16 ClientStatus.
     * @param status The value of C16PacketClientStatus.EnumState
     */
    function sendStatus(status: string): undefined;
    /**
     * Sends a C15 ClientSettings.
     */
    function sendSettings(): undefined;
}
export { script, render, input, world, rise, player, mc, network, packet };
